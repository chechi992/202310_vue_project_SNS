<template>
      <div class="flex flex-col justify-center flex-1 min-h-full px-6 py-12 lg:px-8">
        ...
        <div class="mx-auto mt-8 text-center social_tabs_wrapper max-w-800">
          <span class="block text-sm text-white social_login Baloo">
            他のアカウントでログイン
          </span>
          <div class="flex gap-5 px-5 py-2 social_tabs bg-gray_500">
            <div class="flex items-center gap-4 p-2 bg-gray_800 social_tabs_twitter">
              <!-- Twitter -->
              <svg
            ...
            <div class="flex items-center gap-4 p-2 bg-gray_800 social_tabs_Google">
              <!-- Google -->
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-7 w-7"
            ...
            <div class="flex items-center gap-4 p-2 bg-gray_800 social_tabs_facebook">
              <!-- Facebook -->
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-7 w-7"
        ...
        <div class="mt-3 sm:mx-auto sm:w-full sm:max-w-lg">
          <span class="flex justify-center p-3 text-xs text-white login_title">
            メールでログイン
          </span>
